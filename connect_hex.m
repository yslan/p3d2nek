...
function  con_table=connect_hex_2d(Hexes)
   iftoiv=[1 2;2 3;3 4;4 1];
   nface=4; nfpts=2;
   Nhex = size(Hexes,1); Face_hex=zeros(Nhex*nface,nfpts); k=0;
...
function  con_table=connect_hex_3d(Hexes)   
